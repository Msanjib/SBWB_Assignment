...
jQuery("#jqGrid").jqGrid({
    ...
    colModel:[
    {name:'userId',index:'userId', width:80,align:"center", sorttype:"int", editable: true},
    {name:'firstName',index:'firstName',align:"left", width:110, editable: true},
    {name:'lastName',index:'lastName', width:110, align:"center", editable: true},
