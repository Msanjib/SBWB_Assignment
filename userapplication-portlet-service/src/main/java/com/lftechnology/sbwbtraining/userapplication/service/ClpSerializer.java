...
import com.lftechnology.sbwbtraining.userapplication.model.EmpClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "userapplication-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "userapplication-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.lftechnology.sbwbtraining.userapplication.model.impl.EmpImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "com.lftechnology.sbwbtraining.userapplication.NoSuchEmpException")) {
            return new com.lftechnology.sbwbtraining.userapplication.NoSuchEmpException();
        }
