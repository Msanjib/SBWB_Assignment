...
import com.lftechnology.sbwbusers.model.EmployeeClp;
...
public class ClpSerializer {
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.lftechnology.sbwbusers.model.impl.EmployeeImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "com.lftechnology.sbwbusers.NoSuchEmployeeException")) {
            return new com.lftechnology.sbwbusers.NoSuchEmployeeException();
        }
