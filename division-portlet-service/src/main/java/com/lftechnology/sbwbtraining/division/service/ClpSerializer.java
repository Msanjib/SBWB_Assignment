...
import com.lftechnology.sbwbtraining.division.model.DivisionClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "division-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "division-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.lftechnology.sbwbtraining.division.model.impl.DivisionImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "com.lftechnology.sbwbtraining.division.NoSuchDivisionException")) {
            return new com.lftechnology.sbwbtraining.division.NoSuchDivisionException();
        }
