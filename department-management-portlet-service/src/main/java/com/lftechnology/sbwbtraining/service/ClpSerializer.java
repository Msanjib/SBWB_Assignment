...
import com.lftechnology.sbwbtraining.model.DepartmentClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "department-management-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "department-management-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.lftechnology.sbwbtraining.model.impl.DepartmentImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "com.lftechnology.sbwbtraining.NoSuchDepartmentException")) {
            return new com.lftechnology.sbwbtraining.NoSuchDepartmentException();
        }
