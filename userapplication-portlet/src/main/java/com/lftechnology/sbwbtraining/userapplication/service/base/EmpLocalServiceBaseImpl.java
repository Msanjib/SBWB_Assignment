 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lftechnology.sbwbtraining.userapplication.service.impl.EmpLocalServiceImpl}.
 * </p>
 *
...
public abstract class EmpLocalServiceBaseImpl extends BaseLocalServiceImpl
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.lftechnology.sbwbtraining.userapplication.service.EmpLocalServiceUtil} to access the emp local service.
     */
     ...
     * @return the new emp
     */
    public Emp createEmp(long userId) {
        return empPersistence.create(userId);
    }
    ...
    public Emp deleteEmp(long userId) throws PortalException, SystemException {
        return empPersistence.remove(userId);
    }
    ...
    public Emp fetchEmp(long userId) throws SystemException {
        return empPersistence.fetchByPrimaryKey(userId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Emp getEmp(long userId) throws PortalException, SystemException {
        return empPersistence.findByPrimaryKey(userId);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.lftechnology.sbwbtraining.userapplication.model.Emp",
            empLocalService);
    }
